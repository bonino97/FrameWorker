      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <p class="navbar-brand">Crear lenguaje</p>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Crear lenguaje</h4>
                </div>
                <div class="card-body">
                  <form action="../create-lenguage" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <label class="bmd-label-floating">Ruta</label>
                          <input name ="path" type="text" class="form-control" style="color: gray">
                        </div>
                      </div>
                        <div class="col-md-12">
