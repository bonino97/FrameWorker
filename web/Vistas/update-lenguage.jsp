                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name ="name" type="text" value="<%= Len.getName()%>" class="form-control" style="color: gray">
                        </div>
                        <div class="form-group">
                          <label class="bmd-label-floating">Ruta</label>
                          <input name ="path" value="<%= Len.getPath()%>" type="text" class="form-control" style="color: gray">
                        </div>
                      </div>
                        <div class="col-md-12">
