                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name ="name" type="text" value="<%= Lib.getName()%>" class="form-control" style="color: gray">
                          <p style="margin-top: 10px;"><strong>Lenguaje:</strong> <%= Lib.getLenguage().getName() %></p>
                        </div>
                      </div>
                        <div class="col-md-12">
